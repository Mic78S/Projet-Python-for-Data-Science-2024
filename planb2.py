...
base_url = "https://www.donjondudragon.fr/drs/ad-d2/bestiaire-monstrueux.html?start={}"
#num_pages_to_scrape = 
...
while start != 120:
    url = "https://www.donjondudragon.fr/drs/ad-d2/bestiaire-monstrueux.html?start={start}"
    start = start +20
    print(url)
...
frequency = valeurs_classes[1:1350:21]
climate = valeurs_classes[0:1350:21]
hitdices = valeurs_classes[11:1350:21]
